        ...
        while (true) {
            ...
            if (achou){
                ...
                if ( resp.ToUpper() == "A"){
                    ...
                    // (a conta e toda a sua movimentação)
                    this.titConta = this.tela.perguntar(11, 12, "Excluir conta? (S/N) : ");

                    //pergunta se o usuário confirma exclusão
                    this.tela.limparArea(11,13,69,13);
                    resp = this.tela.perguntar(11, 13, "Tem certeza, meu guri? (S/N) : ");
                    if (resp.ToUpper()=="S"){
                ...
                // não achou a conta, mostra a mensagem e pergunta se deseja
                // cadastrar uma nova conta
                string resp = this.tela.perguntar(11, 13, "Conta não existente. Deseja cadastrar? (S/N) : ");
                if (resp.ToUpper() == "S"){
